...
def english_number number
  ...
  num_string = '' #this is the string that will return
  # "left" is how much of the nnumber we have left
  ...
  if write > 0
    if write == 1
      ...
      #ones place, we have nothing left to write
      left == 0
    elsif write == 2
  ...
  #somewhere in between 0 abd 100, so we need
  # to retun "num_string".
  num_string
end
